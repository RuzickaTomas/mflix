...
public class ConnectionTest extends TicketTest {
	...
	public void testMoviesCount() {
		long expected = 23530;
		assertEquals(expected, dao.getMoviesCount(), "Check your connection string");
	}
	...
	public void testConnectionFindsDatabase() {
		...
		assertTrue(found, "We can connect to MongoDB, but couldn't find expected database. Check the restore step");
	}
	...
	public void testConnectionFindsCollections() {
		...
		assertEquals(found, collectionNames.size(), "Could not find all expected collections. Check your restore step");
	}
}
