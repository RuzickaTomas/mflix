...
public class QueryBuilders extends AbstractLesson {
  ...
  public void testContrastSingleFieldQuery() {
    ...
    assertEquals(actual, builderActual);
  }
  ...
  public void contrastArrayInQuery() {
    ...
    assertEquals(results, oldResults);
  }
  ...
  public void testProjectionBuilder() {
    ...
    assertEquals(3, oldResult.keySet().size());
    assertTrue(oldResult.keySet().containsAll(Arrays.asList("_id", "title", "year")));
    ...
    assertEquals(2, newResult.keySet().size());
