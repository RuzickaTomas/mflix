...
public class MongoClientLesson extends AbstractLesson {
  ...
  public void MongoDatabaseInstance() {
    ...
    assertTrue(dbnames.contains("sample_mflix"));
    ...
    assertEquals("primary", readPreference.getName());
  }
  ...
  public void MongoCollectionInstance() {
    ...
    assertEquals(20, cursor.into(documents).size());
  }
  ...
  public void DocumentInstance() {
    ...
    */
    ...
    assertTrue(document instanceof Bson);
